...
/**
 * MarketingPage — Super Admin "marketing" section.
 *
 ...
 */
export class MarketingPage extends AdminBasePage {
  readonly path = AdminRoutes.marketing;
  protected readonly heading = AdminSelectors.headings.marketing;
